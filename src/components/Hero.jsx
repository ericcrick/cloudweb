  ...
  return (
    <div className='w-full h-screen bg-zinc-200 flex flex-col justify-between'>
      <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
        ...
        <div>
          <img className='w-full' src={bgImage} alt="backgroundImage"/>
        </div>
        <div className='absolute flex flex-col py-8 
              md:min-w-[760px] bottom-[5%]
              nx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200
